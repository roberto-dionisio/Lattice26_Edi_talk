...
The naive ladder **chokes to 9.5%** acceptance at the crossover — its rate-limiting
rung. The learned schedule keeps every rung **uniform**, so replicas **round-trip**.
:::
:::
::: {.column width="42%"}
::: {.fragment .lead style="text-align:center; font-size:0.72em; margin-top:0.2em"}
...
:::{.div style="margin-top:6.0em; font-size:0.88em; text-align:center;"} 
...
:::{.div style="text-align:center; margin-top:-0.8em; font-size:0.88em"}
