...
## Fighting freezing = choosing an annealing protocol {auto-animate=true}
...
## The machine finds the geometry {.money}
...
## The payoff: an unclogged ladder

![](figures/fig_res_swaps.svg)

::: {.fragment .lead style="text-align:center; margin-top:0.3em; font-size:0.72em"}
The naive ladder throttles to **9.5%** swap acceptance at the freezing transition
*(left)*; the geodesic spreads the load evenly — worst rung **16%** — so replicas
actually **round-trip**. The sKL loss *(right)* settles onto that optimum.
:::

## Not a schedule — a field
...
- **throughout** — a spatial **halo** the sharp defect boundary cannot express
:::
...
- Topological freezing is **exponential** — it needs an annealing protocol to fight it
- The optimal protocol is a **Fisher geodesic**
- ML **recovers this geometry** with minimal assumptions, and generalizes to full
  spatial coupling fields

::: {.lead}
**Outlook:** scaling to larger volumes and full QCD; other defect geometries.
:::
...
[your.name@institution.edu](mailto:your.name@institution.edu)
